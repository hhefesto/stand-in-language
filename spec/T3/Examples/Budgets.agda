------------------------------------------------------------------------
-- T3.Examples.Budgets — budgets compute by refl.
--
-- Frozen compatibility oracle mapping: k = semantic bound + 2. Our budget IS
-- the semantic bound.
--   * dPow shape: bounds 3,4,6  ↦  churchK 5,6,8
...
--     (sizing-invisibility divergence)
------------------------------------------------------------------------
