...
--
-- Source of truth: @telomare3\/spec\/T3\/Core\/Ty.agda@ (objects) and
-- @telomare3\/spec\/T3\/Core\/Syntax.agda@ (morphisms).  This module is a
...
telomare3Version = "telomare3 0.1.0.0 (M2: core mirror)"
