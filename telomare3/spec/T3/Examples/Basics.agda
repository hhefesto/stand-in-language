...
--
-- The M1 gate (design/TELOMARE3-DESIGN.md §4): the telomare2.agda §10
-- examples reprove with IDENTICAL numbers through the consolidated graded
-- semantics, plus new examples exercising the M1 additions (whileS,
-- guardS).  Each named fact here becomes a Haskell test vector 1:1 by
-- name at milestone M2 (test/SpecVectors.hs).
------------------------------------------------------------------------
...
-- ── telomare2.agda §10, reproved through ⟦_⟧G ───────────────────────────────
