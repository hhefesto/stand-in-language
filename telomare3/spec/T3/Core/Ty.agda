------------------------------------------------------------------------
-- T3.Core.Ty — objects of the telomare3 core category.
--
-- Ported from design/telomare2.agda §2 (frozen predecessor).
--
-- DECISION (telomare2 design doc §14.2, recorded here): box depth lives on
...
-- The modality is cost/discipline-relevant, value-irrelevant.  In telomare3
...
-- spaces) is milestone M5 (design/TELOMARE3-DESIGN.md §2.7).
------------------------------------------------------------------------
