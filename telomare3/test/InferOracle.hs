...
--
-- ORACLE: telomare1's structural pass is ground truth.  Producing command
-- (run 2026-07-13, repo root, branch bend-port):
--
...
-- dPow shape (design/VALIDATION.md §4): a depth-3 iteration tower.
dPowPort :: Program
...
-- pow on church literals (VALIDATION §6): no sized {t,s,b} sites at all —
