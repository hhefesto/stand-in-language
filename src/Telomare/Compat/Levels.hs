...
import Telomare.Compat.Syntax (AUPT, HighTermF (..), LamTermF (..),
                               LocatedName (..), UnprocessedParsedTermF (..),
                               locStartLineColumn, unAnnotatedUPT)
    ...
    Right parsed ->
      ...
      in case Map.lookup "main" gs of
           ...
           Just mainDef ->
             ...
             in unlines $
                  [ "-- structural EAL box placement (compatibility prototype)"
