...
module Telomare.Compat.TypeChecker where
...
import Telomare.Compat.Syntax (AbortableF (..), BasicExprF (..),
                               FunctionIndex (FunctionIndex), LocTag (..),
                               PartialType, PartialTypeF (..), StuckF (..),
                               Term3, Term3F (..), TypeCheckError (..),
