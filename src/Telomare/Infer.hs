...
--
-- Two layers, mirroring @spec\/T3\/Place.agda@:
--
...
--      compatibility structural-level report reimplemented over a mini-AST — syntactic
...
--
-- test\/InferOracle.hs gates this against frozen compatibility oracle shapes.
module Telomare.Infer
...
-- real programs (the oracle ports live in test\/InferOracle.hs).
data Expr
